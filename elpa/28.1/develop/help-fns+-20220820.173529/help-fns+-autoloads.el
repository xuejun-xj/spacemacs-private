;;; help-fns+-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "help-fns+" '("describe-" "help-" "variable-name-history" "with-selected-frame"))
